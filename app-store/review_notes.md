...
The app uses Apple In-App Purchase for a small catalog unlock product:
`batal.catalog.unlock`.
The payment flow is used to unlock protected catalog pages and part-number details.
