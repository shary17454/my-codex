...
struct WildlifeSpeciesProfile: Identifiable, Hashable {
    ...
    static let samples: [WildlifeSpeciesProfile] = [
        ...
        WildlifeSpeciesProfile(arabicName: "النمر العربي", scientificName: "Panthera pardus nimr", imageName: "cat.fill", dangerLevel: .critical, isVenomous: false, identification: "قط كبير نادر جدًا ومهدد بالانقراض، له جسم مرقط وذيل طويل ويتجنب الإنسان غالبًا.", distribution: "مرتفعات وسلاسل جبلية محدودة جدًا في الجزيرة العربية، وغالبًا ضمن نطاقات حماية ومراقبة.", habitat: "الجبال الوعرة، الشعاب الصخرية، والمناطق قليلة الإزعاج.", activeSeason: "طوال العام.", activityPeriod: .night, viewingAdvice: "لا تقترب ولا تنشر موقعه علنًا. وثق المشاهدة من مسافة آمنة وأبلغ الجهة المختصة.", firstAid: ["ابتعد بهدوء ولا تحاصره.", "عند إصابة بشرية اطلب الإسعاف فورًا.", "أبلغ الجهات البيئية المختصة دون كشف الموقع للعامة."], emergencyNumbers: "الإسعاف 997، والمركز الوطني لتنمية الحياة الفطرية عبر قنواته الرسمية."),
        WildlifeSpeciesProfile(arabicName: "قط الرمال", scientificName: "Felis margarita", imageName: "cat.circle", dangerLevel: .low, isVenomous: false, identification: "قط صغير فاتح اللون، أذناه عريضتان نسبيًا، ويتخفى جيدًا في الرمال.", distribution: "الصحارى الرملية والمناطق المفتوحة في الجزيرة العربية.", habitat: "الكثبان، الأراضي الرملية الهادئة، ومناطق الجحور.", activeSeason: "طوال العام.", activityPeriod: .night, viewingAdvice: "راقبه من بعيد ولا تطعمه أو تلاحقه؛ إزعاجه يضر بسلوكه الطبيعي.", firstAid: ["عند خدش أو عضة، اغسل الجرح وراجع المركز الصحي عند الحاجة."], emergencyNumbers: "للطوارئ الطبية استخدم أرقام بلدك الرسمية."),
        ...
        WildlifeSpeciesProfile(arabicName: "الوبر الصخري", scientificName: "Procavia capensis", imageName: "mountain.2.circle", dangerLevel: .low, isVenomous: false, identification: "ثديي صغير يعيش جماعيًا بين الصخور، جسمه ممتلئ وأذناه قصيرتان.", distribution: "الجبال والحواف الصخرية في غرب وجنوب غرب الجزيرة العربية.", habitat: "الصخور، الكهوف الصغيرة، والحواف الجبلية ذات الشقوق.", activeSeason: "طوال العام.", activityPeriod: .day, viewingAdvice: "لا تطعمه ولا تقترب من الجحور؛ راقبه بالمنظار من مسافة هادئة.", firstAid: ["لا توجد إسعافات خاصة عادة، ونظف أي خدش عند التلامس غير المقصود."], emergencyNumbers: "للطوارئ الطبية استخدم أرقام بلدك الرسمية."),
        WildlifeSpeciesProfile(arabicName: "الجربوع الصحراوي", scientificName: "Jaculus spp.", imageName: "hare", dangerLevel: .low, isVenomous: false, identification: "قارض صغير بساقين خلفيتين طويلتين يتحرك بقفزات سريعة ليلًا.", distribution: "الصحارى الرملية والسهول المفتوحة.", habitat: "الجحور الرملية، الكثبان، والمناطق ذات الغطاء النباتي الخفيف.", activeSeason: "طوال العام ويزيد نشاطه في الليالي المعتدلة.", activityPeriod: .night, viewingAdvice: "لا تطارده بالمركبة أو الأضواء، واترك الجحور دون إزعاج.", firstAid: ["لا توجد إسعافات خاصة عادة."], emergencyNumbers: "للطوارئ الطبية استخدم أرقام بلدك الرسمية."),
        WildlifeSpeciesProfile(arabicName: "السلحفاة البرية", scientificName: "Testudo kleinmanni / Testudinidae", imageName: "tortoise.fill", dangerLevel: .low, isVenomous: false, identification: "زاحف بطيء ذو درع صلب، يظهر بعد الأمطار وفي البيئات الهادئة.", distribution: "مناطق صحراوية وسهول متفرقة بحسب توفر الغطاء النباتي.", habitat: "الشجيرات، السهول الحصوية، وحواف الأودية بعد المواسم الرطبة.", activeSeason: "الربيع وبداية الصيف.", activityPeriod: .day, viewingAdvice: "لا تنقلها من مكانها ولا تضعها على الطرق؛ أبعدها فقط عن الخطر المباشر باتجاه سيرها.", firstAid: ["أبلغ الجهات المختصة عند وجود إصابة أو اتجار غير نظامي."], emergencyNumbers: "الجهات البيئية المختصة."),
...
struct GeospatialMapLayer: Identifiable, Hashable {
    ...
    static let officialSamples: [GeospatialMapLayer] = [
        ...
        GeospatialMapLayer(
            ...
            provider: "خرايم / مساهمات المجتمع",
...
struct GeospatialSearchResult: Identifiable, Hashable {
    ...
    static let samples: [GeospatialSearchResult] = [
        ...
        GeospatialSearchResult(name: "وادي حنيفة", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 24.6190, longitude: 46.5730), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "حافة العالم", type: "مطل", coordinate: CLLocationCoordinate2D(latitude: 24.9530, longitude: 45.9960), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبل طويق", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 24.5229, longitude: 46.2748), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "روضة خريم", type: "روضة", coordinate: CLLocationCoordinate2D(latitude: 25.3828, longitude: 47.2552), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "نفود الثويرات", type: "نفود", coordinate: CLLocationCoordinate2D(latitude: 26.0900, longitude: 44.1500), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "الدهناء", type: "صحراء", coordinate: CLLocationCoordinate2D(latitude: 24.7000, longitude: 47.9000), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "وادي الرمة", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 26.0000, longitude: 43.8000), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبال أجا", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 27.5200, longitude: 41.6900), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبال سلمى", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 27.2500, longitude: 42.1800), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "حرة خيبر", type: "حرة", coordinate: CLLocationCoordinate2D(latitude: 25.6300, longitude: 39.7500), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "حرة رهط", type: "حرة", coordinate: CLLocationCoordinate2D(latitude: 23.0000, longitude: 39.7500), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "وادي الديسة", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 27.6500, longitude: 36.4500), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبال حسمي", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 28.3000, longitude: 35.3000), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "السودة", type: "مرتفع", coordinate: CLLocationCoordinate2D(latitude: 18.2700, longitude: 42.3700), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبال فيفاء", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 17.2500, longitude: 43.1000), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "وادي لجب", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 17.6000, longitude: 42.9500), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبل شدا", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 19.8400, longitude: 41.3100), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبل ورقان", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 24.2100, longitude: 39.2700), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "وادي الفرع", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 23.1500, longitude: 39.0500), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "وادي وج", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 21.3800, longitude: 40.4300), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "وادي بيشة", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 19.9800, longitude: 42.6000), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "وادي نجران", type: "وادي", coordinate: CLLocationCoordinate2D(latitude: 17.4900, longitude: 44.1300), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "حرة كشب", type: "حرة", coordinate: CLLocationCoordinate2D(latitude: 22.8300, longitude: 41.3500), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "جبل القهر", type: "جبل", coordinate: CLLocationCoordinate2D(latitude: 17.8700, longitude: 43.0800), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "يبرين", type: "صحراء", coordinate: CLLocationCoordinate2D(latitude: 23.2500, longitude: 49.0000), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "صحراء جبة", type: "نفود", coordinate: CLLocationCoordinate2D(latitude: 28.0030, longitude: 40.9390), source: "فهرس خرايم"),
        GeospatialSearchResult(name: "العلا", type: "معلم", coordinate: CLLocationCoordinate2D(latitude: 26.6085, longitude: 37.9232), source: "فهرس خرايم")
    ]
}
