...
الإصدار المطلوب الآن هو `2.1`، ورقم البناء الأدنى هو `98`. تم إغلاق مسار `2.0` في App Store Connect بعد اعتماده سابقًا، لذلك يجب ألا يرفع Xcode Cloud أي Build جديد على `2.0`. يجب ضبط Xcode Cloud Next Build Number على `98` أو رقم أعلى من كل Builds الظاهرة في App Store Connect قبل أي Archive جديد.
