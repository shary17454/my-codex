...
final class AIAssistantViewModel {
    ...
    init(questions: [AskQuestion], knowledgeItems: [KnowledgeItem]) {
...
struct AIDecisionAssistantView: View {
    ...
    init(questions: [AskQuestion], knowledgeItems: [KnowledgeItem]) {
        _viewModel = State(initialValue: AIAssistantViewModel(questions: questions, knowledgeItems: knowledgeItems))
    }
        ...
        VStack(alignment: .leading, spacing: 10) {
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("يستخدم المقارنات والمكتبة الحالية. لا يرسل محادثتك إلى خادم خارجي في هذه النسخة.")
                        .font(.subheadline)
                        .foregroundStyle(WeshTheme.secondaryText)
                }
            }
