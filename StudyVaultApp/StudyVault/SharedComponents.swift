    ...
    var body: some View {
        ZStack {
            Circle()
                .fill(
                    RadialGradient(
                        colors: [WeshTheme.gold.opacity(0.22), WeshTheme.gold.opacity(0.03), .clear],
                        center: .center,
                        startRadius: 6,
                        endRadius: size * 0.72
                    )
            ...
            Circle()
                .fill(WeshTheme.surface.opacity(0.44))
...
struct FeaturedDecisionCard: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(
                colors: [
                    WeshTheme.elevatedSurface,
                    WeshTheme.accent.opacity(0.16),
                    WeshTheme.gold.opacity(0.13)
                ],
            ...
            HStack(alignment: .center, spacing: 14) {
                VStack(alignment: .leading, spacing: 12) {
                    Label("رحلة القرار", systemImage: "location.north.circle.fill")
