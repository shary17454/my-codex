...
- آخر رفض موثق في البريد لتطبيق وش الراي كان `2.0 (98)` بتاريخ 31 يوليو 2026 لأن مسار `2.0` مغلق بعد اعتماده سابقًا. الإصدار الجاري للإرسال التالي هو `2.1 (102+)`.
...
- آخر Build مرفوض موثق لهذا التطبيق هو `98` على مسار `2.0` المغلق. قبل أي Build جديد اضبط Xcode Cloud Next Build Number على `102` أو رقم أعلى من كل Builds الظاهرة في App Store Connect.
