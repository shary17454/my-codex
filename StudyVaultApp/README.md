...
- آخر رفض موثق من App Store Connect بتاريخ 31 يوليو 2026 كان للإصدار `2.0` والبناء `97` بسبب `ITMS-90186` و`ITMS-90062`: مسار `2.0` مغلق لأنه يساوي آخر إصدار معتمد. إصدار الإرسال التالي في المشروع هو `2.1` مع Build أساسه `98` أو أعلى من كل Builds الظاهرة في App Store Connect.
