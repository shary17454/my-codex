...
- آخر رفض موثق من App Store Connect بتاريخ 31 يوليو 2026 كان للأبنية `2.1 (113-115)` بسبب `ITMS-90186` و`ITMS-90062`: مسار `2.1` مغلق بعد اعتماد الإصدار. إصدار الإرسال التالي في المشروع هو `2.2` مع Build أساسه `116` أو أعلى من كل Builds الظاهرة في App Store Connect.
