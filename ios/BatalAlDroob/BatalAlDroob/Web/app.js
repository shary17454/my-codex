...
const translations = {
  ar: {
    ...
    partRequestSubtitle: "جهز بيانات القطعة كمسودة واضحة يمكن نسخها وإرسالها للمتاجر السعودية والخليجية والعالمية.",
    requestCustomerFeesTitle: "نوع المسودة",
    requestFreeLabel: "مجاني",
  ...
  en: {
    ...
    partRequestSubtitle: "Prepare a clear part-request draft that can be copied and sent to Saudi, Gulf, and global stores.",
    requestCustomerFeesTitle: "Draft type",
    requestFreeLabel: "Free",
