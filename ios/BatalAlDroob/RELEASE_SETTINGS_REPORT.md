...
> التشغيلية الأحدث موثقة في
> `docs/CURRENT_RELEASE_STATUS.md`: نجح Xcode Cloud Build 109 من commit
> `d6c265c` باستخدام Xcode 26.6 وSDK 26.5، ورقم البناء التالي 110.
